...
const RegisterForms = () => {
  ...
  const [isRepetedPasswordValid, setIsRepetedPasswordValid] = useState<boolean>(false);
  const [repetedPasswordTouched, setRepetedPasswordTouched] = useState<boolean>(false);
      ...
      <form action="">
        <div className={styles["forms-fields-container"]}>
          ...
          <input
            ...
            onChange={(event) => {
              ...
              setIsBlankUserName(event.target.value.trim() === "" ? true : false);
            }}
            className={isBlankUserName && userNameTouched ? styles.invalid : ""}
          />
        ...
        <div className={styles["forms-fields-container"]}>
          ...
          <input
            ...
            className={isPasswordValid && passwordTouched ? "" : styles.invalid}
          />
        ...
        <div className={styles["forms-fields-container"]}>
          ...
          <input
            ...
            className={isRepetedPasswordValid && repetedPasswordTouched ? "" : styles.invalid}
          />
